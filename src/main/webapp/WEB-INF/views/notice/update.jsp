...
<h1>계시글수정</h1>
    ...
    $(function(){
        ...
        $("#updatebtn").click(function(){
        	...
        	$('#btnconfirmupdatenot').click(function(){
        		$('#confirmupdatenot').modal('hide');
        	});
        });
    })
    </script><br>
...
<div id="confirmupdatenot" class="modal fade" role="dialog">
  <div class="modal-dialog modal-sm">
    	<div class="panel panel-success">
		  ...
		  <div class="panel-footer text-center">
		    ...
		    <button class="btn btn-danger glyphicon glyphicon-remove" id="btnconfirmupdatenot">취소</button>
		  </div>
		</div>
  </div>
</div>
