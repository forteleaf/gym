...
<div class="row">
	<div class="col-xs-6">
<section class="panel">
<div class="panel-heading"> ${dto.id }님의 정보 </div>
...
<div class="col-xs-6">
<section class="panel">
<div class="panel-heading"> ${dto.id }님의 운동기록 </div>
	<input type="hidden" id="idss" value="${dto.id }">
			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane fade in active" id="calochart">
					<canvas id="userCalo" width="600" height="350"></canvas>
				</div>
				<div role="tabpanel" class="tab-pane fade" id="weichart">
					<canvas id="userWeight" width="600" height="350"></canvas>
				</div>
			</div>
		</div>
		</section>
