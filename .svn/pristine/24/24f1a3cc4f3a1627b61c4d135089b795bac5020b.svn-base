    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/qna/multiplePhotoUpload'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/qna/photoUpload',	//샘플 URL입니다.
 	        sCallback : '/qna/resources/editor/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
